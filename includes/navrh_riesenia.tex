...
\begin{itemize}
    ...
    \footnotetext{Pod podmienkou, že nahraný súbor a trasy, ktoré obsahuje boli úspešne spracované.}
...
\subsection{Ukladanie údajov  \label{section:saving-files}}
