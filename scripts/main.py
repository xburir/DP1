...
def file_process(dir,file):
    ...
    ## MAPMATCH
    geometry = map_match(points,costing = "bus")
    if geometry != None:
...
def folder_process(dir):
    for file in os.listdir(dir):
        if not path.isdir(dir+file):
            file_process(dir,file)


dir = "C:/Users/richard.buri/search_web/python/"
...
file_process(dir,"mobile_data.csv")